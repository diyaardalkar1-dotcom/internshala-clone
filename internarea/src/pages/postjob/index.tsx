...
// import axios from "axios";
// import { User, Lock, Briefcase, Building2, MapPin, Tags, Info, Users, DollarSign, Calendar, Router } from "lucide-react";
...
//     const handlesubmit=async(e:React.FormEvent)=>{
//         e.preventDefault()
//         const hasemtyfields=Object.values(formData).some(val=>!val.trim())
//         if (hasemtyfields){
