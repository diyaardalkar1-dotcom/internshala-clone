    ...
    const fetchdata = async () => {
      try {
        const [internshipres, jobres] = await Promise.all([
          axios.get("https://internshala-clone-esnd.onrender.com/api/internship"),
          axios.get("https://internshala-clone-esnd.onrender.com/api/job"),
        ]);
...
// import "swiper/css/navigation";
// import "swiper/css/pagination";
// import { ArrowUpRight, Banknote, Calendar, ChevronRight, Link, MapPin } from "lucide-react";
...
//   ];
//   const [selectedCategory,setSelectedCategory] = useState("");
//   const filteredInternship = internships.filter((item)=>!selectedCategory || item.category === selectedCategory);
//   const filteredjobs = jobs.filter((item)=>!selectedCategory || item.category === selectedCategory);
//   return (
//     <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
//       {/* hero section */}
//       <div className="text-center mb-12">
...
//       {/* INternship grid   */}
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
//         {filteredInternship.map((internship: any, index: any) => (
//           <div
//             key={index}
//             className="bg-white rounded-lg shadow-md p-6 transition-transform hover:transform hover:scale-105"
//           >
