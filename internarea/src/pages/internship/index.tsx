...
const index = () => {
  ...
  useEffect(()=>{
    const fetchdata=async()=>{
      try {
        const res=await axios.get( "https://internshala-clone-esnd.onrender.com/api/internship")     
...
// import React, { useEffect, useState } from "react";
// import { ArrowUpRight, Calendar, Clock, DollarSign, Filter, PlayCircle, X } from "lucide-react";
// import Link from "next/link";
// const internshipData = [
//     {
//         _id: "1",
