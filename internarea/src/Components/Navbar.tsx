...
//            email:"xyz@gmail.com",
//             photo:
//             "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=64&h=64&fit=crop7crop-faces",
//         });
//     };
//     const handlelogout = () => {
//         signOut(auth);
...
//               {user ? (
//                 <div className="relative flex">
//                   <button className="flex items-center space-x-2" onClick={() => setIsProfileDropdown(!isProfileDropdown)}>
